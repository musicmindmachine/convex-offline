...
type ComponentApi<Name extends string | undefined = string | undefined> = {
  encryption: {
    approveDevice: FunctionReference<"mutation", "internal", {
      collection: string;
      deviceId: string;
      userId: string;
      wrappedUmk: ArrayBuffer;
    }, any, Name>;
    getDocKey: FunctionReference<"query", "internal", {
      collection: string;
      document: string;
      userId: string;
    }, any, Name>;
    getDocKeysForUser: FunctionReference<"query", "internal", {
      collection: string;
      userId: string;
    }, any, Name>;
    getPendingDevices: FunctionReference<"query", "internal", {
      collection: string;
      userId: string;
    }, any, Name>;
    getWrappedUmk: FunctionReference<"query", "internal", {
      collection: string;
      deviceId: string;
      userId: string;
    }, any, Name>;
    ...
    registerDevice: FunctionReference<"mutation", "internal", {
      collection: string;
      deviceId: string;
      name?: string;
    ...
    storeDocKey: FunctionReference<"mutation", "internal", {
      collection: string;
      document: string;
      userId: string;
  ...
  mutations: {
    ...
    runCompaction: FunctionReference<"mutation", "internal", {
      id: string;
      retain?: number;
      timeout?: number;
    }, null | {
    ...
    scheduleCompaction: FunctionReference<"mutation", "internal", {
      collection: string;
      document: string;
      retain?: number;
      timeout?: number;
